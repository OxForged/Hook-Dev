...
/// @dev `ILatchRegistry` declares the registry's events, errors and types but no functions -
/// its callable surface lives on the concrete `LatchRegistry`. This narrow interface lets the
